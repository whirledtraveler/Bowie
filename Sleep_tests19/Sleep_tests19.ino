...
#define SAMPLE_BUFFER 4 // size of sample buffer arrays, must be a multiple of SAMPLES_PER_SECOND
// Now calculate how many seconds can elapse before the buffer must be
// written to the SD card. 
#define SAMPLE_LOOPS SAMPLE_BUFFER/SAMPLES_PER_SECOND
